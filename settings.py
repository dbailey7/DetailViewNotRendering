"""
Django settings for cmpbltrproj project.
...
SECRET_KEY = 'o0n@)@oj#e@r_j(+b%_rep(vt&@4g0cvzh@xyx0=2vo0v@d)t5';
...
ADMIN_COLORS = [
    ...
    ('Meed Theme', 'customtheme/css/meedmaster.css'),
];
...
WSGI_APPLICATION = 'cmpbltrproj.wsgi.application';
